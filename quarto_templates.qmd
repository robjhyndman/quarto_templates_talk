...
* The workingpaper template has the same yaml as the quarto templates for academic journals.
* So simply changing the format line to `format: elsevier-pdf`, for example, will work.
